				...
				<table class="table table-striped table-hover admin-ncc-table">
					<thead>
						<tr>
							...
							<th style="cursor: pointer;" onclick="sortTable('#admin-ncc-main table.table', 1)" >
							Mã Nhà Cung Cấp
							</th>
							<th style="cursor: pointer;" onclick="sortTable('#admin-ncc-main table.table', 2)" >
							Tên Nhà Cung Cấp
							</th>
							<th style="cursor: pointer;" onclick="sortTable('#admin-ncc-main table.table', 3)" >
							Địa Chỉ
							</th>
							<th style="cursor: pointer;" onclick="sortTable('#admin-ncc-main table.table', 4)" >
							Số điện thoại
							</th>
							<th>Actions</th>
						</tr>
