			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6 ">
							<a href="#addMulPhanQuyen" id="admin-add-phanquyen" class="btn btn-success" data-toggle="modal">
								<i class="material-icons">&#xE147;</i> <span>Thêm</span>
							</a>
							<a href="#deletePhanQuyenModal" class="btn btn-danger delete" data-toggle="modal" id="admin-delete-phanquyen">
