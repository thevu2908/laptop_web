        ...
        <div class="justify-content-between row">
                    ...
                    <ul class="checkout-method row ps-4" style="row-gap: 16px;">
                        <li class="col-6">
                            <div class="checkout-address-btn flex-column select">
                                ...
                                <div class="checkout-method-describe">Thanh toán qua Internet Banking, Visa, Master,
                                    JCB, VNPAY-QR</div>
                            </div>
                        </li>
                        <li class="col-6">
            ...
            <div class="checkout__right col-4">
                ...
                <div class="row bg-white mb-4 p-4 rounded-3">
                    ...
                    <ul class="ps-4">
                        <li class="btn btn-warning w-100 align-self-start text-white mb-2"
                            style="font-weight: 500; align-self: flex-start;">DCT12563943 - Tuần lễ vàng</li>
                        <li class="btn btn-warning w-100 align-self-start text-white mb-2" style="font-weight: 500;">
                            HKS45238752 - Ngày hội việc làm</li>
                        <li class="btn btn-warning w-100 align-self-start text-white mb-2" style="font-weight: 500;">
                            HKS45238752 - Ngày hội việc làm</li>
                    </ul>
                </div>
