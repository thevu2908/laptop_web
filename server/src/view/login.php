                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1 py-5">
                    <form class="login-form" method="post" autocomplete="off" id="login-form">
                        ...
                        <div class="d-flex justify-content-between">
                            <a class="btn btn-primary btn-lg btn-block flex-fill btn-fb-login" style="background-color: #3b5998" href="#!" role="button">
                                <i class="fab fa-facebook-f me-2"></i>Facebook
                            </a>
                            <a class="btn btn-primary btn-lg btn-block flex-fill btn-gg-login" style="background-color: #55acee" href="#!" role="button">
