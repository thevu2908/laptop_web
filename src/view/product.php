            ...
            <div class="product-filter col-2">
                <div class="filter-container category-filter">
                    ...
                    <div class="filter-list row">
                        ...
                        <div class="filter-item col-6">
                            <a href="index.php?san-pham?dell" class="filter-item-link">
                                <i class="fa-regular fa-square"></i>
                                Dell
                            </a>
                        </div>
                        <div class="filter-item col-6">
                            <a href="index.php?san-pham?asus" class="filter-item-link">
                                <i class="fa-regular fa-square"></i>
                                Asus
                            </a>
                        </div>
                        <div class="filter-item col-6">
                            <a href="index.php?san-pham?hp" class="filter-item-link">
                                <i class="fa-regular fa-square"></i>
                                HP
                            </a>
                        </div>
                        <div class="filter-item col-6">
                            <a href="index.php?san-pham?acer" class="filter-item-link">
                                <i class="fa-regular fa-square"></i>
                                Acer
                            </a>
                        </div>
